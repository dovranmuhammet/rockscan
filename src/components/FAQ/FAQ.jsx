...
const FAQ = () => {
    ...
    return (
      <>
        <p>
          ...
          registered with Rock Identifier and let others log into the same
          account on their devices. To do so, please follow the instructions
          below:
        </p>
        <ol>
          <li> Launch Rock Identifier app;</li>
          <li>
    ...
    return (
      <>
        ...
        <ol>
          ...
          <li>Launch the Rock Identifier app;</li>
      ...
      <>
        ...
        <ol>
          ...
          <li>
            ...
            it means you are enjoying Rock Identifier Premium. If your premium
  ...
  const paymentMethod = () => {
    return (
      <>
        <p>You can easily manage your payment method in your phone’s setting. Please follow the instructions below:</p>
        <ol>
  ...
  const cancelSubscribe = () => {
    return (
      <>
        <p>If you find Rock Identifier Premium doesn't fit your needs, you can cancel your Rock Identifier subscription's auto-renewal at any time by following the steps below, and you will continue to have access to the premium content until the subscription's expiration date.</p>
        <p>For information, please follow the link below.</p>
        <ol>
          <li>App Store:https://support.apple.com/kb/ht4098 </li>
         <li>Google Play: https://support.google.com/googleplay/answer/7018481</li>
        </ol>
      </>
    );
  };
        ...
        <div className="row">
          <div className="col-12">
            <div className={Classes.accordianBlockWrapper}>
              <div className="mb-4">
                <h1 className={Classes.blockTitle}>Using Rock Identifier</h1>
                <Accordian
              ...
              <div className="mb-4">
                ...
                />
                <Accordian
                  title="Do l need to sign up to use Rock Identifier?"
                  content="Signing up is not mandatory for our users to use the Rock Identifier app. Once you successfully download and open Rock Identifier, our system will assign a unique secure account for you to use on your current device. You can access everything with this account. No user-created account is required even if you upgrade to Rock Identifier Premium. However, we do recommend signing up with email to keep your data safe if you lose or change your device."
                />
                <Accordian
              ...
              <div className="mb-4">
                ...
                <Accordian
                  title="What privileges do Rock Identifier Premium offer?"
                  content="Rock Identifier Premium unlocks unlimited smart identifications and full access to info. Ads are also removed for Premium members. You can access everything through the Rock Identifier app, available on iPhone and iPad.
                ...
                />
                <Accordian
                  title="How to check if I am Rock Identifier Premium or Rock Identifier Free?"
